...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_ROTD_AMORFO);
	export_constant(SC_ROTD_ANJO);
	export_constant(SC_ROTD_BRUTO);
	export_constant(SC_ROTD_DEMONIO);
	export_constant(SC_ROTD_DRAGAO);
	export_constant(SC_ROTD_HUMANOIDE);
	export_constant(SC_ROTD_INSETO);
	export_constant(SC_ROTD_MORTOVIVO);
	export_constant(SC_ROTD_PEIXE);
	export_constant(SC_ROTD_PLANTA);
	...
	export_deprecated_constant2("SI_ROTD_AMORFO",1500);
	export_deprecated_constant2("SI_ROTD_ANJO",1501);
	export_deprecated_constant2("SI_ROTD_BRUTO",1502);
	export_deprecated_constant2("SI_ROTD_DEMONIO",1503);
	export_deprecated_constant2("SI_ROTD_DRAGAO",1504);
	export_deprecated_constant2("SI_ROTD_HUMANOIDE",1505);
	export_deprecated_constant2("SI_ROTD_INSETO",1506);
	export_deprecated_constant2("SI_ROTD_MORTOVIVO",1507);
	export_deprecated_constant2("SI_ROTD_PEIXE",1508);
	export_deprecated_constant2("SI_ROTD_PLANTA",1509);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_ROTD_AMORFO);
	export_constant(EFST_ROTD_ANJO);
	export_constant(EFST_ROTD_BRUTO);
	export_constant(EFST_ROTD_DEMONIO);
	export_constant(EFST_ROTD_DRAGAO);
	export_constant(EFST_ROTD_HUMANOIDE);
	export_constant(EFST_ROTD_INSETO);
	export_constant(EFST_ROTD_MORTOVIVO);
	export_constant(EFST_ROTD_PEIXE);
	export_constant(EFST_ROTD_PLANTA);
/// @APIHOOK_END
